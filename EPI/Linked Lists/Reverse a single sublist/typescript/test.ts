import {Node, reverseRange, reverseRange2} from './main';
...
for (const fn of [reverseRange, reverseRange2]) {
    {
        const [n1, n2, n3] = make(3);
        const reversed = fn(n1, 1, 2);
