...
assert(cache.lookup("123") == nil, "cache.lookup(\"123\") == nil #3")
assert(cache.lookup("234")! == 234, "cache.lookup(\"234\")! == 234 #1")

cache.insert("789", price: 789)

assert(cache.lookup("234")! == 234, "cache.lookup(\"234\")! == 234 #2")
...
assert(cache.lookup("234")! == 234, "cache.lookup(\"234\")! == 234 #3")
